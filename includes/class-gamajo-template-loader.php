...
if ( ! class_exists( 'Gamajo_Template_Loader' ) ) {
	 ...
	 *
	 * When using in a plugin, create a new class that extends this one and just overrides the guesty_listings.
	 *
	 * @package Gamajo_Template_Loader
	 * @author  Gary Jones
	 */
	class Gamajo_Template_Loader {
		 ...
		 *
		 * Data is available to the template as guesty_listings under the `$data` variable.
