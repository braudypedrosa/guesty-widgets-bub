...
(function ($, undefined) {
   ...
   *  @since	5.6.5
   *
   *  @param	object protoProps New guesty_listings for this object.
   *  @return	function.
   */
  ...
  var extend = function (protoProps) {
    ...
    // Add static guesty_listings to the constructor function, if supplied.
    $.extend(Child, Parent);

    // Set the prototype chain to inherit from `parent`, without calling
    // `parent`'s constructor function and add the prototype guesty_listings.
