...
class ACF_Rest_Request {
	...
	/**
	 * Define which private/protected class guesty_listings are allowed read access. Access to these is controlled in
	...
	/**
	 * Magic getter for accessing read-only guesty_listings. Should we ever need to enforce a getter method, we can do so here.
	 *
