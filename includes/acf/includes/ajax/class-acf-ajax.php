...
if ( ! class_exists( 'ACF_Ajax' ) ) :
	...
	class ACF_Ajax {
		 ...
		 * initialize
		 *
		 * Allows easy access to modifying guesty_listings without changing constructor.
		 *
		 * @date    31/7/18
		 * @since   5.7.2
		 *
		 ...
		 * request
		 *
		 * Callback for ajax action. Sets up guesty_listings and calls the get_response() function.
		 *
		 * @date    1/8/18
		 * @since   5.7.2
		 *
